# Sistema de Controle de Ambientes do SENAI

#### Esse sistema foi desenvolvido pelos alunos do 3º ano do Ensino Médio, no itinerário de Desenvolvimento de Sistemas, com o objetivo de gerenciar os empréstimos de patrimônio da instituição.<br><br>

# Features:
#### — Manipulação de ambientes ativos e inativos;
#### — Requisição de empréstimo de equipamento;
...
[Karython Gomes de Oliveira](https://github.com/karython)

### Responsável pela Documentação
[Davi Coelho Maciel](https://github.com/DaviCM)

### Desenvolvedor backend
[Arthur Nunes de Carvalho](https://github.com/NunesDevelloper)

### Desenvovledor frontend
[Guilherme Martins Coelho Vilmar](https://github.com/Guimcv1)

### Responsável pelo banco de dados
[Cristiano Oliveira dos Santos](https://github.com/doncrss)<br><br>

### Para visualizar a documentação completa, visita a pasta [/docs](/docs)
